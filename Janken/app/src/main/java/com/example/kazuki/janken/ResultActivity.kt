package com.example.kazuki.janken
...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //decide the hand of the computer
        val comHand = getHand()
        when(comHand){
        ...
        when(gameResult){
            ...
            1 -> resultLabel.setText(R.string.result_win)  //myHand win
            2 -> resultLabel.setText(R.string.result_lose) //myHand lose
        }
